...
public static class RemoveSetEndpoint
{
    public static void Map(RouteGroupBuilder group)
    {
        group.MapPost("{connectionName}/sets/{key}/remove", HandleAsync)
        ...
        CancellationToken cancellationToken)
    {
        return await AZRedisEndpointHelpers.WithConnection(
            ...
            connectionName,
            cancellationToken,
            connection => dataService.RemoveSetAsync(connection, key, request.Members, db, cancellationToken));
    }
}
