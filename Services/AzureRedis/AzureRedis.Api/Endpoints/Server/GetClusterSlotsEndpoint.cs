...
public static class GetClusterSlotsEndpoint
{
    public static void Map(RouteGroupBuilder group)
    {
        group.MapGet("{connectionName}/cluster/slots", HandleAsync)
        ...
        CancellationToken cancellationToken)
    {
        return await AZRedisEndpointHelpers.WithConnection(
            ...
            connectionName,
            cancellationToken,
            connection => serverService.GetClusterSlotsAsync(connection, cancellationToken));
    }
}
