...
public static class GetClusterInfoEndpoint
{
    public static void Map(RouteGroupBuilder group)
    {
        group.MapGet("{connectionName}/cluster/info", HandleAsync)
        ...
        CancellationToken cancellationToken)
    {
        return await AZRedisEndpointHelpers.WithConnection(
            ...
            connectionName,
            cancellationToken,
            connection => serverService.GetClusterInfoAsync(connection, cancellationToken));
    }
}
